...
// @phosphor-icons/react's regular weight (256 viewBox), so glyphs match
// pixel-for-pixel without pulling the dependency into this repo.
import type { SVGProps } from "react";

export interface BrandIconProps extends SVGProps<SVGSVGElement> {
  /** When set, sets explicit width/height. Defaults to className sizing. */
  size?: number | string;
}

function createBrandIcon(path: string) {
...
export const SquaresFourIcon = createBrandIcon(
...
export const ChatCircleDotsIcon = createBrandIcon(
  "M140,128a12,12,0,1,1-12-12A12,12,0,0,1,140,128ZM84,116a12,12,0,1,0,12,12A12,12,0,0,0,84,116Zm88,0a12,12,0,1,0,12,12A12,12,0,0,0,172,116Zm60,12A104,104,0,0,1,79.12,219.82L45.07,231.17a16,16,0,0,1-20.24-20.24l11.35-34.05A104,104,0,1,1,232,128Zm-16,0A88,88,0,1,0,51.81,172.06a8,8,0,0,1,.66,6.54L40,216,77.4,203.53a7.85,7.85,0,0,1,2.53-.42,8,8,0,0,1,4,1.08A88,88,0,0,0,216,128Z",
);

export const AddressBookIcon = createBrandIcon(
  "M83.19,174.4a8,8,0,0,0,11.21-1.6,52,52,0,0,1,83.2,0,8,8,0,1,0,12.8-9.6A67.88,67.88,0,0,0,163,141.51a40,40,0,1,0-53.94,0A67.88,67.88,0,0,0,81.6,163.2,8,8,0,0,0,83.19,174.4ZM112,112a24,24,0,1,1,24,24A24,24,0,0,1,112,112Zm96-88H64A16,16,0,0,0,48,40V64H32a8,8,0,0,0,0,16H48v40H32a8,8,0,0,0,0,16H48v40H32a8,8,0,0,0,0,16H48v24a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V40A16,16,0,0,0,208,24Zm0,192H64V40H208Z",
);

export const MegaphoneSimpleIcon = createBrandIcon(
...
export const FlowArrowIcon = createBrandIcon(
  "M245.66,74.34l-32-32a8,8,0,0,0-11.32,11.32L220.69,72H208c-49.33,0-61.05,28.12-71.38,52.92-9.38,22.51-16.92,40.59-49.48,42.84a40,40,0,1,0,.1,16c43.26-2.65,54.34-29.15,64.14-52.69C161.41,107,169.33,88,208,88h12.69l-18.35,18.34a8,8,0,0,0,11.32,11.32l32-32A8,8,0,0,0,245.66,74.34ZM48,200a24,24,0,1,1,24-24A24,24,0,0,1,48,200Z",
);

export const RobotIcon = createBrandIcon(
...
export const BellIcon = createBrandIcon(
...
export const GitBranchIcon = createBrandIcon(
...
export const StorefrontIcon = createBrandIcon(
  "M224,48H175.47L160.23,27.56A8,8,0,0,0,152.93,24H103.07a8,8,0,0,0-7.3,4.56L80.53,48H32A16,16,0,0,0,16,64V80a8,8,0,0,0,8,8H36.35l9.72,116.55A16,16,0,0,0,61.89,216H194.11a16,16,0,0,0,15.82-13.45L219.65,88H240a8,8,0,0,0,8-8V64A16,16,0,0,0,224,48ZM103.07,40h49.86l10.13,16H92.94ZM56.68,88l-9.71-116.29a.37.37,0,0,1,.37-.41H84.48L91.34,40,38.39,40,36.35,88ZM194.11,200H61.89L52.34,88H207.66Z",
);